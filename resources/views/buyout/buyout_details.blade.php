<!-- Modal -->
<div class="modal fade" id="buyoutDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         ...
         <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="total_amt" name="total_amt" placeholder="0.00" required>
                </div>
                <div class="form-group">
