<div class="modal fade" id="viewProject{{ $projectDetails->id }}" tabindex="-1" role="dialog" aria-labelledby="viewProject"
	aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-4">
						<h4>Project Name</h4>
						<p class="text-wrap">{{ $projectDetails->project_name }}</p>
					</div>
					<div class="col-md-4">
						<h4>Project Type</h4>
					...
					<div class="col-md-6">
						...
						<ul>
							@foreach ($projectDetails->attachment as $attachment)
								<li>
									<a class="text-wrap" style="text-decoration:none;" href="{{ url($attachment->attachment) }}" target='_blank'
										title="Open File"><span class="ti-file"></span></a>
								</li>
							@endforeach
						</ul>
					</div>
